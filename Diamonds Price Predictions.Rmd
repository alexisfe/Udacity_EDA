...
Forward step-wise creation of a price prediction linear model
```{r}
...
Load big diamonds dataset
```{r}
load("input/BigDiamonds.rda")
```
...
Residual errors over carat - Values > 1.5 carat are heteroskedastic and therefore with a weaker predicitive power over price
```{r}
...
Estimation of diamond price with intervals
```{r}
